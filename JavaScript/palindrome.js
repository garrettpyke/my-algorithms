///// Palindrome test /////
// Set 'str' variable to any word; this function will return true or false.
...
//get str length
//compare outer chars
//increment inwards until midpoint, which is str.len / 2 if even
...
function palindromeCheck(word) { 
    j = 1 //keeps track of end characters  
    // stop testing at midpoint of word. len/2 works for both odd and even numbered letters b/c modulus is dropped.
    for (i=0; i < len/2; i++) {
